...
function dragula (initialContainers, options) {
  ...
  function drag (e) {
    ...
    if (
      ...
      try {
        dropTarget.insertBefore(item, reference && reference.host ? reference.querySelector('*') : reference);  
      } catch (ex) {
  ...
  function getReference (dropTarget, target, x, y) {
    ...
    function inside () { // faster, but only available if dropped inside a child element
      var rect = target.getBoundingClientRect ? target.getBoundingClientRect() : target.querySelector('*').getBoundingClientRect()
      if (horizontal) {
